...
void log_head(std::string write_file_n, std::string path_str, std::string cmd_output, std::string out_str_p, std::string out_str, int pid) {
...
void log_tail(std::string write_file_n, std::string junk_file_of_args, std::string output_logfile, std::string crash_logfile, std::string cmd_output, std::string out_str_p, std::string out_str, int pid) {
